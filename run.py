...
def method(data,dataset_name,method):
    ...
    for i,row in data.iterrows():
        ...
        if method=='direct':
            a="Document: "+doc+"\n\nQ: Is the following statement factually consistent with the above document? Yes or No?\n"+ row[4]+"\n\nA:"
            # a="Document: "+doc+"\n\nQ: Is the following statement factually consistent with the above document?\n"+ row[4]+"\n\nA:"
            ...
            a="Document: "+doc+"\n\n"
            a+="Q: Is the following statements factually consistent with the above document? Yes or No?\n"
        ...
        if method=='direct' or method=='twoshot_direct' or method=='sbs' or method=='twoshot_sbs':
            res=max(0,res-('No' in generate or 'no' in generate))
...
def print_saveresult(data,data_name,result):
    ...
    if not os.path.exists('new_result4'):
        os.makedirs('new_result4') 
    output='new_result4/'+time_+'_'+str(len(data))+'.csv'
...
if __name__ =='__main__':
    ...
    if not os.path.exists('new_result4'):
        os.makedirs('new_result4')
    make_print_to_file(path='new_result4/')
    args=parse_args()
    data_name=args.data

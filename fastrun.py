...
def method(data,dataset_name,method):
    ...
    for i,row in data.iterrows():
        ...
        if method=='direct':
            ...
            a="Document: "+doc+"\n\n"
            a+="Q: Does the above document entail the following statements? Yes or No?\n"
